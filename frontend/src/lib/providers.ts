...
const FOREIGN_PROVIDERS: Provider[] = [
  ...
  { name: 'VixSrc', displayName: 'OSK+ VixSrc', description: 'Foreign — VixSrc, high quality HLS', brandColor: '#10b981', url: (t, tp, s, e) => `/api/extract/vixsrc/${t}?type=${tp}${s ? `&season=${s}` : ''}${e ? `&episode=${e}` : ''}`, priority: 24, category: 'foreign', needsResolution: true },
  { name: 'HDbox', displayName: 'OSK+ HDbox', description: 'Foreign — HDbox/MovieBox, multi-dub streams', brandColor: '#ef4444', url: (t, tp, s, e) => `/api/extract/hdbox/${t}?type=${tp}${s ? `&season=${s}` : ''}${e ? `&episode=${e}` : ''}`, priority: 25, category: 'foreign', needsResolution: true },
  { name: 'Vidzee', displayName: 'OSK+ Vidzee', description: 'Foreign — Vidzee player, 14 servers', brandColor: '#a855f7', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://player.vidzee.wtf/embed/${t}?ss=${s}&ep=${e}` : `https://player.vidzee.wtf/embed/${t}`, priority: 26, category: 'foreign' },
  { name: 'VidMoly', displayName: 'OSK+ Moly', description: 'Foreign — VidMoly host', brandColor: '#f59e0b', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://vidmoly.to/embed/${t}/${s}/${e}` : `https://vidmoly.to/embed/${t}`, priority: 27, category: 'foreign' },
  { name: 'Upstream', displayName: 'OSK+ Up', description: 'Foreign — Upstream host', brandColor: '#14b8a6', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://upstream.to/embed/${t}/${s}/${e}` : `https://upstream.to/embed/${t}`, priority: 28, category: 'foreign' },
  { name: 'EvoLoad', displayName: 'OSK+ Evo', description: 'Foreign — EvoLoad host', brandColor: '#ef4444', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://evoload.io/e/${t}/${s}/${e}` : `https://evoload.io/e/${t}`, priority: 29, category: 'foreign' },
  { name: 'GDrivePlayer', displayName: 'OSK+ GDrive', description: 'Foreign — Google Drive source', brandColor: '#3b82f6', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://gdriveplayer.to/embed/${t}/${s}/${e}` : `https://gdriveplayer.to/embed/${t}`, priority: 30, category: 'foreign' },
  { name: 'MegaCloud', displayName: 'OSK+ Mega', description: 'Foreign — MegaCloud host', brandColor: '#8b5cf6', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://megacloud.tv/embed-${t}/${s}/${e}` : `https://megacloud.tv/embed-${t}`, priority: 31, category: 'foreign' },
  { name: 'GoodStream', displayName: 'OSK+ Good', description: 'Foreign — GoodStream host', brandColor: '#14b8a6', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://goodstream.uno/e/${t}/${s}/${e}` : `https://goodstream.uno/e/${t}`, priority: 32, category: 'foreign' },
  { name: 'StreamLare', displayName: 'OSK+ Lare', description: 'Foreign — StreamLare host', brandColor: '#ec4899', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://streamlare.com/e/${t}/${s}/${e}` : `https://streamlare.com/e/${t}`, priority: 33, category: 'foreign' },
  { name: 'Fastream', displayName: 'OSK+ Fastream', description: 'Foreign — Fastream host', brandColor: '#06b6d4', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://fastream.to/e/${t}/${s}/${e}` : `https://fastream.to/e/${t}`, priority: 34, category: 'foreign' },
  { name: 'Linkbox', displayName: 'OSK+ Link', description: 'Foreign — Linkbox host', brandColor: '#ef4444', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://linkbox.to/e/${t}/${s}/${e}` : `https://linkbox.to/e/${t}`, priority: 35, category: 'foreign' },
  { name: 'StreamHide', displayName: 'OSK+ Hide', description: 'Foreign — StreamHide host', brandColor: '#8b5cf6', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://streamhide.to/e/${t}/${s}/${e}` : `https://streamhide.to/e/${t}`, priority: 36, category: 'foreign' },
  { name: 'FileLions', displayName: 'OSK+ Lions', description: 'Foreign — FileLions host', brandColor: '#f97316', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://filelions.to/e/${t}/${s}/${e}` : `https://filelions.to/e/${t}`, priority: 37, category: 'foreign' },
  { name: 'Dokicloud', displayName: 'OSK+ Doki', description: 'Foreign — Dokicloud host', brandColor: '#0ea5e9', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://dokicloud.one/e/${t}/${s}/${e}` : `https://dokicloud.one/e/${t}`, priority: 38, category: 'foreign' },
  { name: 'Vidstack', displayName: 'OSK+ Stack', description: 'Foreign — Vidstack player', brandColor: '#d946ef', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://vidstack.io/e/${t}/${s}/${e}` : `https://vidstack.io/e/${t}`, priority: 39, category: 'foreign' },
  { name: 'StreamHub', displayName: 'OSK+ Hub', description: 'Foreign — StreamHub host', brandColor: '#f43f5e', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://streamhub.to/e/${t}/${s}/${e}` : `https://streamhub.to/e/${t}`, priority: 40, category: 'foreign' },
  { name: 'BigWarp', displayName: 'OSK+ Warp', description: 'Foreign — BigWarp host', brandColor: '#10b981', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://bigwarp.art/e/${t}/${s}/${e}` : `https://bigwarp.art/e/${t}`, priority: 41, category: 'foreign' },
  { name: 'Byse', displayName: 'OSK+ Byse', description: 'Foreign — Byse host', brandColor: '#f59e0b', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://byse.sx/e/${t}/${s}/${e}` : `https://byse.sx/e/${t}`, priority: 42, category: 'foreign' },
  { name: 'Cdnplayer', displayName: 'OSK+ CDN', description: 'Foreign — CDN Player', brandColor: '#ec4899', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://cdnplayer.online/e/${t}/${s}/${e}` : `https://cdnplayer.online/e/${t}`, priority: 43, category: 'foreign' },
];
...
const ARABIC_PROVIDERS: Provider[] = [
  ...
  { name: 'MyCima', displayName: 'OSK+ ماي سيما', description: 'Arabic — MyCima scraped streams', brandColor: '#3b82f6', url: (t) => `/api/streams/${t}?category=arabic`, priority: 2, category: 'arabic', needsResolution: true },
  { name: 'ArabSeed', displayName: 'OSK+ عرب سيد', description: 'Arabic — ArabSeed scraped streams', brandColor: '#f59e0b', url: (t) => `/api/streams/${t}?category=arabic`, priority: 3, category: 'arabic', needsResolution: true },
  { name: 'EgyBest', displayName: 'OSK+ إيجي بست', description: 'Arabic — EgyBest scraped streams', brandColor: '#ef4444', url: (t) => `/api/streams/${t}?category=arabic`, priority: 4, category: 'arabic', needsResolution: true },
  { name: 'CimaCima', displayName: 'OSK+ سينما سينما', description: 'Arabic — CimaCima scraped streams', brandColor: '#8b5cf6', url: (t) => `/api/streams/${t}?category=arabic`, priority: 5, category: 'arabic', needsResolution: true },
  { name: 'Akwam', displayName: 'OSK+ أكوام', description: 'Arabic — Akwam scraped streams', brandColor: '#14b8a6', url: (t) => `/api/streams/${t}?category=arabic`, priority: 6, category: 'arabic', needsResolution: true },
  { name: 'CimaClub', displayName: 'OSK+ سينما كلوب', description: 'Arabic — CimaClub scraped streams', brandColor: '#06b6d4', url: (t) => `/api/streams/${t}?category=arabic`, priority: 7, category: 'arabic', needsResolution: true },
  { name: 'MovizLand', displayName: 'OSK+ موفيز لاند', description: 'Arabic — MovizLand scraped streams', brandColor: '#f97316', url: (t) => `/api/streams/${t}?category=arabic`, priority: 8, category: 'arabic', needsResolution: true },
  { name: 'Cinemana', displayName: 'OSK+ سينمانا', description: 'Arabic — Cinemana scraped streams', brandColor: '#d946ef', url: (t) => `/api/streams/${t}?category=arabic`, priority: 9, category: 'arabic', needsResolution: true },
  { name: 'Hd1', displayName: 'OSK+ HD1', description: 'Arabic — Hd1.brstej scraped streams', brandColor: '#ec4899', url: (t) => `/api/streams/${t}?category=arabic`, priority: 10, category: 'arabic', needsResolution: true },
  // ─── General embed servers (may have Arabic subtitles) ───
  { name: 'vidlink', displayName: 'OSK+ Play Arabic', description: 'Arabic — General embed, Arabic subs', brandColor: '#ffd700', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://vidlink.pro/tv/${t}/${s}/${e}` : `https://vidlink.pro/movie/${t}`, priority: 11, category: 'arabic' },
  { name: 'VidFast', displayName: 'OSK+ Fast Arabic', description: 'Arabic — Fast embed, Arabic subs', brandColor: '#10b981', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://vidfast.pro/tv/${t}/${s}/${e}?autoPlay=true` : `https://vidfast.pro/movie/${t}?autoPlay=true`, priority: 12, category: 'arabic' },
  { name: 'EmbedSu', displayName: 'OSK+ Embed Arabic', description: 'Arabic — Embed.su, Arabic subs', brandColor: '#06b6d4', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://embed.su/embed/tv/${t}/${s}/${e}` : `https://embed.su/embed/movie/${t}`, priority: 13, category: 'arabic' },
  { name: 'SmashyStream', displayName: 'OSK+ Smash Arabic', description: 'Arabic — Smashy embed, Arabic subs', brandColor: '#f97316', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://embed.smashystream.com/playere.php?tmdb=${t}&season=${s}&episode=${e}` : `https://embed.smashystream.com/playere.php?tmdb=${t}`, priority: 14, category: 'arabic' },
  { name: 'AutoEmbed', displayName: 'OSK+ Auto Arabic', description: 'Arabic — Auto-embed, Arabic subs', brandColor: '#8b5cf6', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://player.autoembed.app/embed/tv/${t}/${s}/${e}` : `https://player.autoembed.app/embed/movie/${t}`, priority: 15, category: 'arabic' },
  { name: 'MultiEmbed', displayName: 'OSK+ Multi Arabic', description: 'Arabic — Multi-source, Arabic subs', brandColor: '#14b8a6', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://multiembed.mov/?video_id=${t}&tmdb=1&s=${s}&e=${e}` : `https://multiembed.mov/?video_id=${t}&tmdb=1`, priority: 16, category: 'arabic' },
  { name: 'GoodStream', displayName: 'OSK+ Good Arabic', description: 'Arabic — GoodStream, Arabic subs', brandColor: '#14b8a6', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://goodstream.uno/e/${t}/${s}/${e}` : `https://goodstream.uno/e/${t}`, priority: 17, category: 'arabic' },
  { name: 'Frembed', displayName: 'OSK+ FR Arabic', description: 'Arabic — Frembed, Arabic subs', brandColor: '#0ea5e9', url: (t, tp, s, e) => tp === 'tv' ? `https://frembed.cc/api/serie.php?id=${t}&sa=${s || 1}&epi=${e || 1}` : `https://frembed.cc/api/film.php?id=${t}`, priority: 18, category: 'arabic' },
  { name: 'StreamWish', displayName: 'OSK+ Wish Arabic', description: 'Arabic — StreamWish, Arabic subs', brandColor: '#ec4899', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://streamwish.to/e/${t}/${s}/${e}` : `https://streamwish.to/e/${t}`, priority: 19, category: 'arabic' },
  { name: 'FileMoon', displayName: 'OSK+ Moon Arabic', description: 'Arabic — FileMoon, Arabic subs', brandColor: '#8b5cf6', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://filemoon.to/e/${t}/${s}/${e}` : `https://filemoon.to/e/${t}`, priority: 20, category: 'arabic' },
  { name: 'Linkbox', displayName: 'OSK+ Link Arabic', description: 'Arabic — Linkbox, Arabic subs', brandColor: '#ef4444', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://linkbox.to/e/${t}/${s}/${e}` : `https://linkbox.to/e/${t}`, priority: 21, category: 'arabic' },
];
...
const TURKISH_PROVIDERS: Provider[] = [
  ...
  { name: 'Cinemana', displayName: 'OSK+ سينمانا تركي', description: 'Turkish — Cinemana Turkish content', brandColor: '#8b5cf6', url: (t) => `/api/streams/${t}?category=turkish`, priority: 4, category: 'turkish', needsResolution: true },
  // ─── General embed servers (may have Turkish subtitles) ───
  { name: 'vidlink', displayName: 'OSK+ Play Turkish', description: 'Turkish — General embed, Turkish subs', brandColor: '#ffd700', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://vidlink.pro/tv/${t}/${s}/${e}` : `https://vidlink.pro/movie/${t}`, priority: 5, category: 'turkish' },
  { name: 'VidFast', displayName: 'OSK+ Fast Turkish', description: 'Turkish — Fast embed, Turkish subs', brandColor: '#10b981', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://vidfast.pro/tv/${t}/${s}/${e}?autoPlay=true` : `https://vidfast.pro/movie/${t}?autoPlay=true`, priority: 6, category: 'turkish' },
  { name: 'EmbedSu', displayName: 'OSK+ Embed Turkish', description: 'Turkish — Embed.su, Turkish subs', brandColor: '#06b6d4', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://embed.su/embed/tv/${t}/${s}/${e}` : `https://embed.su/embed/movie/${t}`, priority: 7, category: 'turkish' },
  { name: 'SmashyStream', displayName: 'OSK+ Smash Turkish', description: 'Turkish — Smashy embed, Turkish subs', brandColor: '#f97316', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://embed.smashystream.com/playere.php?tmdb=${t}&season=${s}&episode=${e}` : `https://embed.smashystream.com/playere.php?tmdb=${t}`, priority: 8, category: 'turkish' },
  { name: 'AutoEmbed', displayName: 'OSK+ Auto Turkish', description: 'Turkish — Auto-embed, Turkish subs', brandColor: '#8b5cf6', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://player.autoembed.app/embed/tv/${t}/${s}/${e}` : `https://player.autoembed.app/embed/movie/${t}`, priority: 9, category: 'turkish' },
  { name: 'MultiEmbed', displayName: 'OSK+ Multi Turkish', description: 'Turkish — Multi-source, Turkish subs', brandColor: '#14b8a6', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://multiembed.mov/?video_id=${t}&tmdb=1&s=${s}&e=${e}` : `https://multiembed.mov/?video_id=${t}&tmdb=1`, priority: 10, category: 'turkish' },
  { name: 'GoodStream', displayName: 'OSK+ Good Turkish', description: 'Turkish — GoodStream, Turkish subs', brandColor: '#14b8a6', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://goodstream.uno/e/${t}/${s}/${e}` : `https://goodstream.uno/e/${t}`, priority: 11, category: 'turkish' },
  { name: 'Frembed', displayName: 'OSK+ FR Turkish', description: 'Turkish — Frembed, Turkish subs', brandColor: '#0ea5e9', url: (t, tp, s, e) => tp === 'tv' ? `https://frembed.cc/api/serie.php?id=${t}&sa=${s || 1}&epi=${e || 1}` : `https://frembed.cc/api/film.php?id=${t}`, priority: 12, category: 'turkish' },
  { name: 'StreamWish', displayName: 'OSK+ Wish Turkish', description: 'Turkish — StreamWish, Turkish subs', brandColor: '#ec4899', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://streamwish.to/e/${t}/${s}/${e}` : `https://streamwish.to/e/${t}`, priority: 13, category: 'turkish' },
  { name: 'FileMoon', displayName: 'OSK+ Moon Turkish', description: 'Turkish — FileMoon, Turkish subs', brandColor: '#8b5cf6', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://filemoon.to/e/${t}/${s}/${e}` : `https://filemoon.to/e/${t}`, priority: 14, category: 'turkish' },
  { name: 'Linkbox', displayName: 'OSK+ Link Turkish', description: 'Turkish — Linkbox, Turkish subs', brandColor: '#ef4444', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://linkbox.to/e/${t}/${s}/${e}` : `https://linkbox.to/e/${t}`, priority: 15, category: 'turkish' },
];
