  ...
  return (
    ...
    >
      ...
      <div className="mt-1.5 sm:mt-2 px-0.5 space-y-0.5" dir="auto">
        <h3
          className="text-[11px] sm:text-xs md:text-sm font-semibold text-white truncate leading-tight"
          dir="auto"
        >
          {title}
        </h3>
        <div className="flex items-center gap-1.5 sm:gap-2 text-[10px] sm:text-xs text-zinc-500 flex-wrap">
          {year && (
            <span className="mixed-text" dir="auto">
              {year}
            </span>
          )}
          {rating > 0 && (
            <span className="flex items-center gap-0.5 text-emerald-400 font-semibold">{rating}%</span>
          )}
        </div>
        {genreNames && (
          <p className="text-[10px] sm:text-xs text-zinc-600 truncate leading-tight" dir="auto">
            {genreNames}
          </p>
        )}
      </div>
            ...
            <div className="relative aspect-video">
              ...
              <div className="absolute bottom-2.5 left-2.5 right-2.5 flex items-center gap-2">
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 sm:px-4 sm:py-2 rounded-lg sm:rounded-xl bg-white text-black font-bold text-xs sm:text-sm hover:bg-white/90 transition shadow-lg"
                >
