          ...
          <div className="mt-6 pt-6 border-t border-zinc-800 text-center">
            <div className="inline-block p-3 bg-white rounded-xl mb-3">
              <svg width="100" height="100" viewBox="0 0 100 100" className="mx-auto">
                <rect x="5" y="5" width="35" height="35" fill="#111" rx="3"/>
                <rect x="12" y="12" width="8" height="8" fill="#111"/>
                <rect x="25" y="12" width="8" height="8" fill="#111"/>
                <rect x="12" y="25" width="8" height="8" fill="#111"/>
                <rect x="25" y="25" width="8" height="8" fill="#111"/>
                <rect x="60" y="5" width="35" height="35" fill="#111" rx="3"/>
                <rect x="67" y="12" width="8" height="8" fill="#111"/>
                <rect x="80" y="12" width="8" height="8" fill="#111"/>
                <rect x="67" y="25" width="8" height="8" fill="#111"/>
                <rect x="80" y="25" width="8" height="8" fill="#111"/>
                <rect x="5" y="60" width="35" height="35" fill="#111" rx="3"/>
                <rect x="12" y="67" width="8" height="8" fill="#111"/>
                <rect x="25" y="67" width="8" height="8" fill="#111"/>
                <rect x="12" y="80" width="8" height="8" fill="#111"/>
                <rect x="25" y="80" width="8" height="8" fill="#111"/>
                <rect x="45" y="45" width="10" height="10" fill="#111" rx="2"/>
                <rect x="60" y="60" width="10" height="10" fill="#111" rx="2"/>
                <rect x="75" y="60" width="10" height="10" fill="#111" rx="2"/>
                <rect x="60" y="75" width="10" height="10" fill="#111" rx="2"/>
                <rect x="80" y="80" width="15" height="15" fill="#111" rx="2"/>
              </svg>
            </div>
            <p className="text-zinc-500 text-xs">امسح الرمز لتسجيل الدخول السريع</p>
          </div>
        </div>
