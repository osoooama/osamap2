...
const FOREIGN_PROVIDERS: Provider[] = [
  ...
  { name: 'Vidzee', displayName: 'OSK+ Vidzee', description: 'Foreign — Vidzee player, 14 servers', brandColor: '#a855f7', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://player.vidzee.wtf/embed/${t}?ss=${s}&ep=${e}` : `https://player.vidzee.wtf/embed/${t}`, priority: 25, category: 'foreign' },
  { name: 'VidMoly', displayName: 'OSK+ Moly', description: 'Foreign — VidMoly host', brandColor: '#f59e0b', url: (t, tp, s, e) => tp === 'tv' && s && e ? `https://vidmoly.to/embed/${t}/${s}/${e}` : `https://vidmoly.to/embed/${t}`, priority: 26, category: 'foreign' },
