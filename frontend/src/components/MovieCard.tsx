...
import { Play, Star, Calendar, Tv, Monitor } from 'lucide-react';
...
export default function MovieCard({ movie, accentColor = '#E50914' }: MovieCardProps) {
  ...
  return (
    <AnimatePresence mode="wait">
      {playing && tmdbId ? (
        <div className="flex-shrink-0 w-[280px] sm:w-[320px] md:w-[360px]">
          <div
            className="rounded-xl overflow-hidden bg-zinc-900 shadow-lg shadow-black/20 cursor-pointer"
          ...
          >
            ...
            <div className="p-2.5">
              ...
              <div className="flex items-center gap-2 text-xs text-zinc-500 mt-1">
                ...
                {rating && <span className="flex items-center gap-1"><Star className="w-3 h-3 text-yellow-500" />{rating}</span>}
              </div>
            </div>
          </div>
        </div>
