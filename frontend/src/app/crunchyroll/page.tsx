...
import { Sparkles, TrendingUp, Atom, Film } from 'lucide-react';
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                <div className="relative">
                  <div className="w-14 h-14 rounded-2xl overflow-hidden ring-2 ring-orange-500/20">
                    <Image src="/crunchyroll.webp" alt="Crunchyroll" width={56} height={56} className="w-full h-full object-cover" />
                  </div>
                ...
                <div>
                  ...
                  <p className="text-zinc-500 text-sm sm:text-base mt-1">منصة الأنمي - أنمي فقط</p>
                </div>
              </div>
