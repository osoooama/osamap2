  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] relative overflow-hidden">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[-10%] left-[-5%] w-[50%] h-[50%] rounded-full" style={{ background: 'radial-gradient(circle, rgba(5,150,105,0.08) 0%, transparent 70%)' }} />
        <div className="absolute bottom-[-10%] right-[-5%] w-[50%] h-[50%] rounded-full" style={{ background: 'radial-gradient(circle, rgba(16,185,129,0.08) 0%, transparent 70%)' }} />
      </div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-16">
          <motion.div
            ...
            className="w-28 h-28 rounded-3xl overflow-hidden mx-auto mb-6 ring-4 ring-emerald-500/20 shadow-2xl shadow-emerald-600/20"
          >
            <Image src="/logo.webp" alt="OSK+" width={112} height={112} className="w-full h-full object-cover" />
          </motion.div>
          <h1 className="text-4xl sm:text-5xl font-black text-white mb-3 font-arabic-display">
        ...
        >
          <div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-8">
            <button
              ...
              className="w-24 h-24 sm:w-28 sm:h-28 rounded-2xl overflow-hidden border-2 border-emerald-500/30 hover:border-emerald-500/60 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-emerald-500/20 shrink-0 cursor-pointer"
            >
              <Image
                src="/developer.webp"
                alt="أسامة كريشان"
            ...
            <div className="text-center sm:text-right">
              <h2 className="text-2xl sm:text-3xl font-black text-white mb-1 font-arabic-display">أسامة كريشان</h2>
        ...
        >
          <a href="mailto:osamakreshan49@gmail.com" className="glass rounded-2xl p-5 border border-white/5 hover:border-emerald-500/20 transition-all duration-300 group text-center">
          ...
          <a href="https://github.com/osoooama" target="_blank" className="glass rounded-2xl p-5 border border-white/5 hover:border-teal-500/20 transition-all duration-300 group text-center">
            <GitBranch className="w-5 h-5 text-teal-500 mx-auto mb-2" />
          ...
          <a href="#" className="glass rounded-2xl p-5 border border-white/5 hover:border-cyan-500/20 transition-all duration-300 group text-center">
            <Globe className="w-5 h-5 text-cyan-500 mx-auto mb-2" />
        ...
        >
          <h3 className="text-lg font-bold text-white mb-4 flex items-center gap-2 font-arabic-display">
