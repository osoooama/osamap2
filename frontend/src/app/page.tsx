...
const platforms = [
  {
    ...
    icon: Film,
    desc: 'أحدث الأفلام والمسلسلات العالمية',
  ...
  },
  {
    ...
    icon: Tv,
    desc: 'المحتوى العربي والتركي المتنوع',
    bgGradient: 'platform-gradient-shahid',
  },
  {
    name: 'Disney+',
    tagline: 'أفلام كرتون وأنيميشن',
    href: '/disney',
    color: '#113CCF',
    gradient: 'from-blue-600/30 via-blue-600/10 to-transparent',
    icon: Star,
    desc: 'أفلام الكرتون والأنيميشن للعائلة',
  ...
  },
  {
    ...
    icon: Clapperboard,
    desc: 'أفلام ومسلسلات الأنمي الحصرية',
  ...
  return (
    ...
    >
      <Link href={isSignedIn ? p.href : '/sign-in'} className="group block">
        <div
          className={`relative h-[340px] sm:h-[400px] rounded-2xl overflow-hidden transition-all duration-500 ${p.bgGradient} border border-white/5 hover:border-white/20`}
        >
          <motion.div
            className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
            style={{
              background: `radial-gradient(ellipse at center, ${p.color}25, transparent 70%)`,
            }}
          />
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center">
            ...
            {!isSignedIn && (
              <motion.div
                className="mt-6 flex items-center gap-2 px-4 py-2 rounded-full glass text-zinc-400 text-xs"
                initial={{ opacity: 0 }}
        ...
        >
          ...
          <section className="relative min-h-screen flex flex-col items-center justify-center px-4 pt-20">
            ...
            >
              ...
              <motion.h1
                className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-black text-white mb-6 leading-[0.9] tracking-tight"
              ...
              >
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {[
                    ...
                    { number: '7', label: 'مزودي تشغيل', color: '#F47521' },
                  ].map((stat, i) => (
                    <motion.div
                      key={stat.label}
