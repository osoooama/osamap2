            ...
            >
              <div className="flex items-center gap-4 mb-4">
                <div className="relative">
                  <div className="w-14 h-14 rounded-2xl overflow-hidden ring-2 ring-red-500/20">
                    <Image src="/netflix.webp" alt="Netflix" width={56} height={56} className="w-full h-full object-cover" />
                  </div>
                  <div className="absolute -top-1 -right-1 w-3 h-3 rounded-full bg-[#E50914] animate-pulse" />
                </div>
                <div>
                  <h1 className="text-3xl sm:text-4xl md:text-6xl font-black text-white tracking-tight">Netflix</h1>
                  <p className="text-zinc-500 text-sm sm:text-base mt-1">أفلام ومسلسلات عالمية فقط</p>
                </div>
              </div>
